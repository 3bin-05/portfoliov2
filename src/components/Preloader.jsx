      ...
      >
        ...
        <motion.div
          ...
          style={{
            ...
            top: "50%",
            left: "50%",
            marginLeft: -OUTER_RING_SIZE / 2,
            marginTop: -OUTER_RING_SIZE / 2,
          }}
        ...
        <motion.div
          ...
          style={{
            ...
            top: "50%",
            left: "50%",
            marginLeft: -INNER_RING_SIZE / 2,
            marginTop: -INNER_RING_SIZE / 2,
          }}
          initial={{ opacity: 0, scale: 0.8 }}
        ...
        <motion.div
          ...
          style={{
            ...
            position: "absolute",
            filter:
              "drop-shadow(0 0 12px rgba(255, 107, 0, 0.7)) drop-shadow(0 0 20px rgba(255, 107, 0, 0.4))",
          }}
