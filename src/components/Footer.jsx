                    ...
                    <div className="row">
                        <div className="column xl-4 lg-5 md-6 tab-12">
                            ...
                            <ul className="link-list">
                                <li><a href="https://github.com/3bin-05">GitHub</a></li>
                                <li><a href="https://x.com/simply_ebin05?t=yFyVDV_BeotLDlbYfiiB4g&s=09">X</a></li>
                                <li><a href="https://www.instagram.com/_simply._.ebin_?igsh=MWZkOTdoZnJvOG1pdw==">Instagram</a></li>
                                <li><a href="https://www.linkedin.com/in/ebin-reji">LinkedIn</a></li>
                            </ul>
                        </div>
            ...
            <div className="row s-footer__bottom">
                <div className="column xl-6 lg-12">
                    <ul className="s-footer__social social-list">
                        ...
                        <li>
                            <a href="https://x.com/simply_ebin05?t=yFyVDV_BeotLDlbYfiiB4g&s=09">
                        ...
                        <li>
                            <a href="https://www.instagram.com/_simply._.ebin_?igsh=MWZkOTdoZnJvOG1pdw==">
                        ...
                        <li>
                            <a href="https://www.linkedin.com/in/ebin-reji">
